...
def initAttrs():
    global cs_diff, cs_met, cs_rou, cs_nor
    cs_diff = "sRGB"
    cs_met = "sRGB"
    cs_rou = "sRGB"
    cs_nor = "sRGB"
...
def openUi():
    with pm.window(t="ezCreateMaterial") as wn:
        global txDiff, txMetal, txRough, txNormal, frame_diff, frame_met, frame_rou, frame_nor
        txDiff = ""
        txMetal = ""
        txRough = ""
        txNormal = ""
        with pm.columnLayout():
            ...
            with pm.horizontalLayout(ratios=[1, 4], spacing=10):
                # Mesh map selection
                with pm.columnLayout():
                    with pm.frameLayout(l="Mesh maps", bgs=True, w=100):
                ...
                with pm.columnLayout():
                    # Common Settings
                    with pm.frameLayout(l="Common Settings", cll=True, bgs=True, w=400):
                    ...
                    # Diffuse Settings
                    with pm.frameLayout("fl_diff", l="Diffuse", cll=True, bgs=True, w=400) as frame_diff:
                    ...
                    # Metalness Settings
                    with pm.frameLayout("fl_met", l="Metalness", cll=True, bgs=True, w=400) as frame_met:
                        with pm.verticalLayout(ratios=[1, 3], spacing=5):
                            with pm.horizontalLayout(ratios=[12, 1], spacing=10):
                    ...
                    # Roughness Settings
                    with pm.frameLayout("fl_rou", l="Roughness", cll=True, bgs=True, w=400) as frame_rou:
                        with pm.verticalLayout(ratios=[1, 3], spacing=5):
                            with pm.horizontalLayout(ratios=[12, 1], spacing=10):
                    ...
                    # Normal Settings
                    with pm.frameLayout("fl_nor", l="Normal", cll=True, bgs=True, w=400) as frame_nor:
                        with pm.verticalLayout(ratios=[1, 3], spacing=5):
                            with pm.horizontalLayout(ratios=[12, 1], spacing=10):
                    ...
                    with pm.verticalLayout():
                        pm.button(label="Create Material", w=400,
